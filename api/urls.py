...
urlpatterns = [
    ...
    path('categories/update-active/', CategoryActiveUpdateView.as_view(), name='category-update-active'),
    path('categories/<int:category_id>/products/', ProductByCategoryView.as_view(), name='product-by-category'),
