# Generated by Django 5.1.1 on 2024-12-14 03:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller', models.ForeignKey(limit_choices_to={'role__name': 'SELLER'}, on_delete=django.db.models.deletion.CASCADE, related_name='order_items', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'constraints': [models.UniqueConstraint(fields=('product', 'stock', 'variant_name'), name='unique_stock_variant')],
            },
        ),
    ]
